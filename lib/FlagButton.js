...
const FlagWithSomething = memo(({ countryCode, withEmoji, withCountryNameButton, withCurrencyButton, withCallingCodeButton, withFlagButton, flagSize, placeholder, }) => {
    ...
    return (React.createElement(View, { style: [styles.flagWithSomethingContainer, countryCode && { height: flagSize }] },
        countryCode ? (React.createElement(Flag, Object.assign({}, { withEmoji, countryCode, withFlagButton, flagSize: flagSize }))) : (React.createElement(View, { style: { height: flagSize, paddingBottom: 4 } },
