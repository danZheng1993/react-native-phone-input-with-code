    ...
    return (React.createElement(ThemeProvider, { theme: {
        ...
        React.createElement(CountryProvider, { value: { ...DEFAULT_COUNTRY_CONTEXT, translation } },
            React.createElement(View, { style: styles.wrapper },
                React.createElement(CountryPicker, { withFlag: true, withCallingCode: true, withCallingCodeButton: true, withFilter: true, withModal: true, withEmoji: false, modalProps: { visible }, countryCodes: countryCodes, onClose: () => setVisible(false), onOpen: () => setVisible(true), countryCode: countryCode, onSelect: onSelect, placeholder: placeholder, filterProps: { placeholder: filterPlaceholder }, containerButtonStyle: {
